  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-12">
      ...
      >
        ...
        >
          <span className="text-[#1ed760]">Listen Together</span>
          <br />
        ...
        >
          <button
            ...
            disabled={loading}
            className="bg-[#1ed760] hover:scale-105 text-black font-bold text-base px-8 py-3.5 rounded-full min-w-[200px] flex items-center justify-center gap-2 transition-transform disabled:opacity-50"
          >
          ...
          <button
            ...
            disabled={loading}
            className="bg-transparent border border-white hover:border-[#1ed760] hover:text-[#1ed760] text-white font-bold text-base px-8 py-3.5 rounded-full min-w-[200px] flex items-center justify-center gap-2 transition-colors disabled:opacity-50"
          >
      ...
      >
        {[
          ...
          <motion.div
            ...
            className="bg-[#181818] rounded-2xl p-5 text-center hover:bg-[#282828] transition-all duration-300"
          >
            <feature.icon className="text-2xl text-[#1ed760] mx-auto mb-3" />
        ...
        {showJoin && (
          <Modal onClose={() => { setShowJoin(false); setError(''); setRoomCode(''); }}>
            ...
            <button
              ...
              disabled={loading || roomCode.length < 6 || (!user && !username.trim())}
              className="btn-primary w-full py-3 rounded-xl"
              id="join-room-btn"
            >
