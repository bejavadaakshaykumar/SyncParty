...
exports.setupQueueHandlers = setupQueueHandlers;
const Room_js_1 = require("../models/Room.js");
const index_js_1 = require("./index.js");
function setupQueueHandlers(io, socket) {
    ...
    socket.on('queue:reorder', async ({ from, to }) => {
        try {
            const userData = index_js_1.socketUserMap.get(socket.id);
            if (!userData?.roomCode)
                return;
...
//# sourceMappingURL=queueHandlers.js.map